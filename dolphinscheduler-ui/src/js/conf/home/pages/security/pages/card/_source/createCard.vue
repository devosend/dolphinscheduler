    ...
    <template slot="content">
      <div class="create-card-model">
        ...
        <m-list-box-f v-if="statusRef !== 2">
          ...
          <template slot="content">
            <x-select v-model="calendarCode" style="width: 100%;" clearable>
              <x-option
        ...
        <template v-if="statusRef !== 2">
          <m-list-box-f>
            ...
            <template slot="content">
              <x-select v-model="flopDirection" style="width: 100%;">
                <x-option :value="0" :label="$t('Forward')"></x-option>
                <x-option :value="1" :label="$t('Backward')"></x-option>
              </x-select>
            </template>
          </m-list-box-f>
          <m-list-box-f>
          ...
          <m-list-box-f>
            ...
            <template slot="content">
              <x-select v-model="outputFormat" style="width: 100%;">
                <x-option value="yyyyMMdd" label="yyyyMMdd"></x-option>
                <x-option value="yyyy-MM-dd" label="yyyy-MM-dd"></x-option>
                <x-option value="yyyy-MM-dd HH:mm:ss" label="yyyy-MM-dd HH:mm:ss"></x-option>
              </x-select>
            </template>
          </m-list-box-f>
        </template>
  ...
  export default {
    ...
    created () {
      ...
      if (this.item) {
        ...
        // Format card value as date string for display

...
export default {
  ...
  'Date format invalid': '日期格式必须为 yyyy-MM-dd',
  'Date already added': '该日期已添加',
  'Delete success': '删除成功',
  'Create success': '创建成功',
  'Update success': '更新成功',
  ...
  'Create card': '创建牌',
  'Edit card': '编辑牌',
  'Edit card value': '编辑牌值',
  'Card Name': '牌名称',
  'Please enter card name': '请输入牌名称',
  Calendar: '日历',
  'Card Value': '牌值',
  'Card value placeholder': '输入日期（yyyy-MM-dd）',
  'Card value tip': '格式：yyyy-MM-dd 或 yyyy-MM-dd HH:mm:ss',
  'Please enter card value': '请输入牌值',
  'Flop Direction': '翻转方向',
  Forward: '向前',
  Backward: '向后',
  'Day Step': '天步长',
  'Hour Step': '时步长',
  'Minute Step': '分步长',
  'Please enter day step': '请输入天步长',
  'Please enter hour step': '请输入时步长',
  'Please enter minute step': '请输入分步长',
  'Output Format': '输出格式',
  'Date Count': '日期数量',
  'Calendar Name': '日历名称'
}

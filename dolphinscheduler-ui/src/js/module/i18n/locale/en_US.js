...
export default {
  ...
  'Date List': 'Date List',
  'Date input placeholder': 'Enter date (yyyy-MM-dd), multiple separated by comma',
  'Add date': 'Add date',
  ...
  'Edit card': 'Edit card',
  'Edit card value': 'Edit card value',
  'Card Name': 'Card Name',
  'Please enter card name': 'Please enter card name',
  Calendar: 'Calendar',
  'Card Value': 'Card Value',
  'Card value placeholder': 'Enter date (yyyy-MM-dd)',
  'Card value tip': 'Format: yyyy-MM-dd or yyyy-MM-dd HH:mm:ss',
  'Please enter card value': 'Please enter card value',
  'Flop Direction': 'Flop Direction',
  Forward: 'Forward',
  Backward: 'Backward',
  'Day Step': 'Day Step',
  'Hour Step': 'Hour Step',
  'Minute Step': 'Minute Step',
  'Please enter day step': 'Please enter day step',
  'Please enter hour step': 'Please enter hour step',
  'Please enter minute step': 'Please enter minute step',
